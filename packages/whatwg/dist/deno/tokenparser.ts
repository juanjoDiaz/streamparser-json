import { TokenParser, TokenParserOptions } from "https://deno.land/x/streamparser_json@v0.0.10/index.ts";
import { ParsedTokenInfo } from "https://deno.land/x/streamparser_json@v0.0.10/utils/types/parsedTokenInfo.ts";
